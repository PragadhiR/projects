import type { AudiogramData } from '@/types';
...
export function AudiogramChart({ audiogram }: { audiogram: AudiogramData }) {
  return (
    <div className="w-full overflow-x-auto">
      ...
      <div className="mt-3 flex items-center justify-center gap-6 text-xs font-medium text-ink-600">
        <span className="flex items-center gap-1.5">
          <span className="inline-block h-3 w-3 rounded-full bg-brand-600" /> Right Ear
        </span>
        <span className="flex items-center gap-1.5">
